...
FROM in_interventi_tecnici
    ...
    LEFT OUTER JOIN in_statiintervento ON in_interventi.id_stato=in_statiintervento.idstatointervento
WHERE ".$where.'
    idtecnico IN('.implode(',', $tecnici).') AND
    in_interventi.id_stato IN('.implode(',', $stati).') AND
    in_interventi_tecnici.id_tipo_intervento IN('.implode(',', $tipi).') '.Modules::getAdditionalsQuery('Interventi').'
