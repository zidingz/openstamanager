...
echo '
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content '.(!$is_cliente && !$is_fornitore && !$is_tecnico ? 'd-none' : '').'">
                    <div class="tab-pane '.(!$is_cliente && !$is_fornitore ? ' d-none' : '').'" id="cliente_fornitore">
                        <div class="row">
                             <div class="col-md-6">
        ...
        echo '
                    <div class="tab-pane '.(!$is_cliente ? 'd-none' : 'active').'" id="cliente">
                        <div class="row">
                            <div class="col-md-6">
        ...
        echo '
                    <div class="tab-pane '.(!$is_fornitore ? 'd-none' : (!$is_cliente ? 'active' : '')).'" id="fornitore">
                        <div class="row">
                            <div class="col-md-6">
