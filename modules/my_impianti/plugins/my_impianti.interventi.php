...
$rss = $dbo->fetchArray('SELECT in_statiintervento.completato FROM in_statiintervento INNER JOIN in_interventi ON in_statiintervento.id=in_interventi.idstatointervento WHERE in_interventi.id='.prepare($id_record));
