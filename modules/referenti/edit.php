...
<form action="" method="post" role="form">
	...
	<div class="row">
		<div class="col-md-12">
            <a href="#" class="btn btn-danger ask" data-backto="record-edit" data-op="deletereferente" data-id_record="'.$record['id'].'" data-id_plugin="'.$id_plugin.'" data-id_module="'.$id_module.'" data-id_parent="'.$reference_id.'">
                <i class="fa fa-trash"></i> '.tr('Elimina').'
            </a>

			<button type="submit" class="btn btn-primary float-right"><i class="fa fa-plus"></i> '.tr('Modifica').'</button>
		</div>
	</div>
</form>';
?>
