...
if (!empty($righe)) {
    ...
    <h4>
        '.tr('Righe').'
        <button type="button" class="btn btn-info btn-sm float-right" onclick="copy()"><i class="fa fa-copy"></i> '.tr('Copia dati contabili dalla prima riga valorizzata').'</button>
