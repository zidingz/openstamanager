...
echo '
	...
	<div class="row">
		<div class="col-md-12">
            <a class="btn btn-danger ask '.$disabled.'" data-backto="record-edit" data-op="deletesede" data-id="'.$record['id'].'" data-id_module="'.$id_module.'" data-id_parent="'.$id_parent.'" '.$disabled.'>
                <i class="fa fa-trash"></i> '.tr('Elimina').'
            </a>

			<button type="submit" class="btn btn-primary float-right"><i class="fa fa-edit"></i> '.tr('Modifica').'</button>
		</div>
	</div>
</form>';
