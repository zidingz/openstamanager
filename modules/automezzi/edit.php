			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-12" >
						...
						<a href="javascript:;" class="btn btn-sm btn-success float-right" title="Aggiorna date" onclick="$('#updatetech-form input[name=op]').val('savetech'); $('#updatetech-form').submit();"><i class="fa fa-edit"></i> <?php echo tr('Salva date'); ?></a>
