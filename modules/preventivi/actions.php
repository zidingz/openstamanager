...
switch (post('op')) {
    ...
    case 'update':
        if (isset($id_record)) {
            ...
            $preventivo->data_bozza = post('data_bozza', true);
            $preventivo->data_accettazione = post('data_accettazione', true);
            $preventivo->data_rifiuto = post('data_rifiuto', true);
            $preventivo->data_conclusione = post('data_conclusione', true);
