...
echo '
<div class="card card-outline card-info" id="row-'.$calendar_id.'">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($preventivi->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.\Modules\Module::get('Preventivi')['id'].'&search_Cliente='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($contratti->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.\Modules\Module::get('Contratti')['id'].'&search_Cliente='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($ordini_cliente->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.\Modules\Module::get('Ordini cliente')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($interventi->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.\Modules\Module::get('Interventi')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($ddt_uscita->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.\Modules\Module::get('Ddt di vendita')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($fatture_vendita->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.\Modules\Module::get('Fatture di vendita')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
