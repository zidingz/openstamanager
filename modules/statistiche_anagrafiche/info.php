            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($preventivi->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.module('Preventivi')['id'].'&search_Cliente='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($contratti->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.module('Contratti')['id'].'&search_Cliente='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($ordini_cliente->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.module('Ordini cliente')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($interventi->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.module('Interventi')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($ddt_uscita->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.module('Ddt di vendita')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-card-content">
                        ...
                        '.($fatture_vendita->count() > 0 ? '<span class="info-card-text float-right"><a href="'.ROOTDIR.'/controller.php?id_module='.module('Fatture di vendita')['id'].'&search_Ragione-sociale='.$anagrafica['ragione_sociale'].'">'.tr('Visualizza').' <i class="fa fa-chevron-circle-right"></i></a></span>' : '').'
                        <br class="clearfix">
                        <span class="info-card-number">
