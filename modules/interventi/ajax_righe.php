...
<table class="table table-striped table-condensed table-hover table-bordered">
    ...
    <tr>
        ...
        <td class="text-center">
            <button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" onclick="launch_modal(\''.tr('Modifica spesa').'\', \''.$link.'?id_module='.$id_module.'&id_record='.$id_record.'&idriga='.$r['id'].'\', 1);"><i class="fa fa-edit"></i></button>
            <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" onclick="if(confirm(\''.tr('Eliminare questa spesa?').'\')){ elimina_riga( \''.$r['id'].'\' ); }"><i class="fa fa-trash"></i></button>
        </td>';
        }
        echo '
    </tr>';
