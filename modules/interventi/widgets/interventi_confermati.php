...
$rs = $dbo->fetchArray('SELECT * FROM in_interventi WHERE in_interventi.id_stato = (SELECT in_statiintervento.id FROm in_statiintervento WHERE in_statiintervento.codice=\'WIP\') ORDER BY data_richiesta ASC');
